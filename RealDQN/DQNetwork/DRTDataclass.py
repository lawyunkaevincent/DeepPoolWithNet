...
class GlobalStateSummary:
    ...
    # Optional spatial demand/supply grid from ZoneStateTracker.
    # Shape (2, grid_rows, grid_cols), values in [0, 1].
    # None when ZoneStateTracker is not configured.
    spatial_grid: object = None       # np.ndarray | None (avoid numpy import here)
