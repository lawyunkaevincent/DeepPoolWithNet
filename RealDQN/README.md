...
python train_dqn.py --cfg D:\FYP\DeepPoolPer\SunwaySmallMap\osm.sumocfg --imitation-model-dir D:\FYP\DeepPoolPer\DQNImitation\ImitationDL\artifacts\imitation_model --output-dir D:\FYP\DeepPoolPer\RealDQN\DQNetwork\artifacts\dqn_model --episodes 400 --train-every 4 --batch-size 128 --replay-size 50000 --gamma 0.85 --lr 5e-5 --lr-min 1e-6 --tau 0.005 --epsilon-start 0.275 --epsilon-end 0.01 --eval-every 10 --wait-target 250 --ride-time-target 300 --n-step 5