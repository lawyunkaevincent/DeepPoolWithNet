...
Spatial Encoder: 
python train_dqn.py --cfg D:\FYP\DeepPoolPer_Comparison2\SunwaySmallMap\osm.sumocfg --imitation-model-dir D:\FYP\DeepPoolPer_Comparison2\DQNImitation\ImitationDL\artifacts\imitation_model --output-dir D:\FYP\DeepPoolPer_Comparison2\RealDQN\DQNetwork\artifacts\dqn_model_spatial --episodes 400 --train-every 4 --batch-size 128 --replay-size 50000 --gamma 0.85 --lr 1e-4 --lr-min 1e-6 --tau 0.003 --epsilon-start 0.15 --epsilon-end 0.01 --eval-every 10 --wait-target 244 --ride-time-target 335 --n-step 5 --net D:\FYP\DeepPoolPer_Comparison2\SunwaySmallMap\osm.net.xml --epsilon-schedule linear --seed 42 --spatial-encoder